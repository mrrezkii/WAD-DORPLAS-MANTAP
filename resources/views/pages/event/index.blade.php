            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex flex-column">
                            @php
                                $startDate = \Carbon\Carbon::parse($datas[0]->start_date_donor_events);
                                $endDate = \Carbon\Carbon::parse($datas[0]->end_date_donor_events);
                                $startTime = \Carbon\Carbon::parse($datas[0]->start_time_donor_events);
                                $endTime = \Carbon\Carbon::parse($datas[0]->end_time_donor_events);
                            @endphp
                            <img class="img-fluid rounded"
                                 src="{{ $datas[0]->thumbnail_donor_events ?? url('https://cdn-2.tstatic.net/tribunnews/foto/bank/images/ribuan-warga-antri-untuk-suntik-vaksin-covid-19-di-tangerang_20210629_113221.jpg') }}"
                                 alt="image">
                            <p class="ellipsis-2 text-blue text-title1 mt-2">{{ $datas[0]->name_donor_events }}</p>
                            <p>
                                <span class="text-primary text-body1 mt-2">Dorplas</span>
                                <span class="text-secondary text-body1">&bull;</span>
                                <span
                                    class="text-secondary text-body1">{{ $datas[0]->institutions->name_institutions }}</span>
                            </p>
                            ...
                            <p class="text-body1 mt-1">{{ $datas[0]->desc_donor_events }}</p>
                            <p class="text-blue text-title1 mt-2">Alamat</p>
                            <p class="text-body1 mt-1">{{ $datas[0]->institutions->address_institutions }}</p>
                        </div>
                    </div>
