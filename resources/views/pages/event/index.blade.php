    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-12 mt-5">
            ...
            <div class="d-block d-flex flex-column">
                <h4 class="m-0 font-weight-bold text-blue">Detail Acara</h4>
                <img class="img-fluid rounded mt-5"
                     src="https://cdn-2.tstatic.net/tribunnews/foto/bank/images/ribuan-warga-antri-untuk-suntik-vaksin-covid-19-di-tangerang_20210629_113221.jpg"
                     alt="image">
                <p class="ellipsis-2 text-blue text-title1 mt-2">Donor Darah & Kontes Foto di Wilayah Kediri Dalam
                    Rangka Menyambut Hari Donor Darah</p>
                <p>
                    <span class="text-primary text-body1 mt-2">Merdeka</span>
                    <span class="text-secondary text-body1">&bull;</span>
                    <span class="text-secondary text-body1">20-10-2021</span>
                </p>
                ...
                <table class="ml-4 w-75 my-2">
                    <tr>
                        ...
                        <td class="text-grey text-body1">25/10/2021</td>
                    </tr>
                    <tr>
                        <td>
                            <svg width="18" height="20" viewBox="0 0 18 20" fill="none"
                        ...
                        <td class="text-grey text-body1">: &nbsp;</td>
                        <td class="text-grey text-body1">28/10/2021</td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="text-grey text-body1">: &nbsp;</td>
                        <td class="text-grey text-body1">09.00 - 15.00</td>
                    </tr>
                </table>
                <p class="text-blue text-title1 mt-2">Deksripsi</p>
                <p class="text-body1 mt-1">Menyambut Hari Donor Darah Sedunia yang diperingati pada bulan Juni 2020,
                    Palang Merah Indonesia (PMI) Kota Kediri akan melakukan berbagai event.
                    Salah satunya ialah pelaksanaan kontes foto #AyoDonorDarah yang dilakukan dengan cara para pendonor
                    mengunggah foto mereka tengah berdonor dan mentautkan foto tersebut ke Instagram PMI Kota Kediri dan
                    menambahkan tagar #AyoDonorDarah. Sementara bagi yang telah berdonor lebih dari 50 kali, bisa datang
                    ke PMI Kota Kediri untuk mengambil kupon doorprize dan sertifikat penghargaan donor.</p>
                <p class="text-blue text-title1 mt-2">Alamat</p>
                <p class="text-body1 mt-1">Jl. Mayor Bismo No.15, Mojoroto, Kec. Mojoroto, Kota Kediri, Jawa Timur.</p>
